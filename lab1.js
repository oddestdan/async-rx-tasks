...
/*
Стеценко Денис, вар. 17 — Задания 4 6 11 17 2

4. Посчитать количество элементов равных нулю.
6. Помножить элементы  на число.
11. Обнулить четные по значению элементы.
17. Вывести элементы, значения которых равны значениям других элементов.
10. Прибавить к элементам их индекс.
*/
